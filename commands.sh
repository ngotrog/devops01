...
az vm create --resource-group trongnv11-rs --name trong-agent --image Ubuntu2204 --size Standard_DS1_v2 --data-disk-sizes-gb 20 --admin-username agent --admin-password Agentdevops@1314 --nsg-rule SSH --public-ip-sku Standard --generate-ssh-keys
